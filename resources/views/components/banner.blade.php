<div class="main-banner wow fadeIn" id="top" data-wow-duration="1s" data-wow-delay="0.5s">
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="right-image wow fadeInRight text-center" data-wow-duration="1s" data-wow-delay="0.5s">
                    <img src="{{ asset('assets/images/santri-1500.png') }}" alt="Air Mineral Santri" class="img-fluid"
                        style="max-height: 500px; filter: drop-shadow(0 10px 20px rgba(0,0,0,0.3));">
                </div>
            </div>
        </div>
    </div>
