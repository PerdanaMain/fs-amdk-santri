...
<head>
    ...
    <link rel="stylesheet" href="dashboards/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="dashboards/vendors/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" href="dashboards/vendors/typicons/typicons.css">
    <link rel="stylesheet" href="dashboards/vendors/simple-line-icons/css/simple-line-icons.css">
...
<body>
    ...
    <script src="dashboards/vendors/chart.js/Chart.min.js"></script>
    <script src="dashboards/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
    <script src="dashboards/vendors/progressbar.js/progressbar.min.js"></script>

    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="dashboards/js/off-canvas.js"></script>
    ...
    <script src="dashboards/js/dashboard.js"></script>
    <script src="dashboards/js/Chart.roundedBarCharts.js"></script>
